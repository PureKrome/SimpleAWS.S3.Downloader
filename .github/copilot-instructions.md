...
- Use xUnit v3 as the testing framework and specifically the latest Microsoft Test Platform version
- Tests should be run via `dotnet run` on the test project (not `dotnet test`)
